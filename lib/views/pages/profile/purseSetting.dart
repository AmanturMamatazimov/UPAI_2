                              ...
                              Row(
                                ...
                                children: [
                                  Text('Электронный кошелек',
                                      style: TextStyle(
                                        color: Color(0xFF225196).withOpacity(0.4),
                                        fontSize: 14,
                                        fontWeight: FontWeight.w400,
                                      )),
                                  GestureDetector(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            height: 15,
                                            decoration: BoxDecoration(
                                              color:  currentPurseTap==1 ? Color(0xFF225196):null,
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            height: 15,
                                            decoration: BoxDecoration(
                                                color: currentPurseTap==2 ? Color(0xFF225196):null,
                                                shape: BoxShape.circle,
                                                border: Border.all(width: 1,color: Color(0xFF225196))
                                            ),
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            height: 15,
                                            decoration: BoxDecoration(
                                                color: currentPurseTap==3 ? Color(0xFF225196):null,
                                                shape: BoxShape.circle,
                                                border: Border.all(width: 1,color: Color(0xFF225196))
                                            ),
          ...
          Padding(
            ...
            child: GestureDetector(
              child: Container(
                ...
                child: Center(
                  child: Text('Вывести деньги на карту',style: TextStyle(color: Color(0xFFFF6B00),fontSize: 14)),
                ),
              ),
            ),
          ),
